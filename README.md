...
in standard input, and write them to standard output. Contrary to
[`wc`](https://en.wikipedia.org/wiki/Wc_(Unix)), it will also update standard
output while it is still counting.
